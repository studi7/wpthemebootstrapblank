		...
		<div class="row">
			<div class="col-md-3">
				...
				<?php $wp_query = new WP_Query(); $wp_query->query('showposts=1&post_type=projects'); ?>
		    		<h4><?php _e('Box 1','wpthemebootstrapblank'); ?></h4>
				...
				<?php endwhile; else: ?>
					<p><?php _e('No published projects.','wpthemebootstrapblank'); ?></p>
				<?php endif; ?>

			</div>
			<div class="col-md-3">
				<h4><?php _e('Box 2','wpthemebootstrapblank'); ?></h4>

			</div>
			<div class="col-md-3">
				<h4><?php _e('Box 3','wpthemebootstrapblank'); ?></h4>
				<address>
			...
			<div class="col-md-3">
				<h4><?php _e('Box 4','wpthemebootstrapblank'); ?></h4>
			</div>
		</div>
	</div>
      </footer>
