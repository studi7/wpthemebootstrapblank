...
$myquery = new WP_Query( $args );
			...
			echo '<div class="col-sm-6 col-md-3"><div class="thumbnail">';
				...
				echo '<div class="caption">
            			...
            			<div class="row"><a class="readmore" href="'.get_permalink($post->ID).'">Llegir més</a></div></div>';
				echo '</div></div>';
				
		 endwhile;?>
		</div><div class="pager"><ul><li><?php previous_posts_link('Projectes anteriors'); ?></li>&nbsp;<li><?php next_posts_link('Projectes següents', $myquery->max_num_pages); ?></li></ul></div>
